                ...
                <div className="search-options">
                    <div className="selected-areas">
                        ...
                        {selectedAreas && selectedAreas.map((area, index) => {
                            ...
                            return <div ref={areaContainer} className="selected-area-container" onMouseEnter={() => setIsDeleteButtonVisible(index)} onMouseLeave={() => setIsDeleteButtonVisible(false)}>
